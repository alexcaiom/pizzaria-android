package com.fabiano.pizzaria.utils.mapa;
...
public class TracadorDeRota extends Classe {
	public final static String MODE_DRIVING = "driving";
	public final static String MODE_WALKING = "walking";

	private LatLng localizacaoInicial = null;
	private LatLng localizacaoFinal = null;
	private Document doc = null;
	
	public TracadorDeRota() {
	}
	
	public TracadorDeRota de(LatLng minhaLocalizacao){
		if (existe(minhaLocalizacao)) {
			this.localizacaoInicial = minhaLocalizacao;
		}
		return this;
	}
	
	public TracadorDeRota ate(LatLng localizacaoDestino){
		if (existe(localizacaoDestino)) {
			this.localizacaoFinal = localizacaoDestino;
		}
		return this;
	}
	
	
	public void aplicarRotaAoMapa(GoogleMap mapa){
		if (existe(mapa)) {
			HTTPClientTask tarefa = new HTTPClientTask();
			try {
				Void dados = null;
				doc = tarefa.execute(dados).get();
	...
	public class HTTPClientTask extends AsyncTask<Void, Void, Document> {
    	@Override
    	protected Document doInBackground(Void... nada) {
    		TracadorDeRota md = new TracadorDeRota();
    		Document docWeb = md.getDocument(localizacaoInicial, localizacaoFinal, TracadorDeRota.MODE_DRIVING);
    		return docWeb;
    	}
    }
